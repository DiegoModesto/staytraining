...
namespace Infra.Database.Migrations
{
    ...
    [Migration("20260724154722_AddWorkoutScheduleStatusAndSwap")]
    partial class AddWorkoutScheduleStatusAndSwap
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Execution.WorkoutSchedule", b =>
                {
                    ...
                    b.Property<Guid?>("SwappedFromScheduleId")
                        .HasColumnType("uuid")
                        .HasColumnName("swapped_from_schedule_id");

                    b.Property<Guid?>("SwappedToScheduleId")
                        .HasColumnType("uuid")
                        .HasColumnName("swapped_to_schedule_id");
            ...
            modelBuilder.Entity("Domain.Questions.Question", b =>
                {
                    ...
                    b.Property<string>("AnsweredByName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("answered_by_name");
                    ...
                    b.HasIndex("TenantId", "AnswerText")
                        .HasDatabaseName("ix_questions_tenant_id_answer_text");

                    b.HasIndex("TenantId", "StudentId")
                        .HasDatabaseName("ix_questions_tenant_id_student_id");
